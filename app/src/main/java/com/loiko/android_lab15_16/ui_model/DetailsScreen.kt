...
import com.loiko.android_lab15_16.data.sampleSubjects
        ...
        Column(
            ...
            Card(modifier = Modifier.fillMaxWidth()) {
                Column(
                    ...
                    DetailRow(label = "Баллы", value = subject.credits.toString())
                    HorizontalDivider()
                    DetailRow(label = "Текущая оценка", value = subject.currentGrade)
                }
            }
            Card(modifier = Modifier.fillMaxWidth()) {
                Column(modifier = Modifier.padding(16.dp)) {
