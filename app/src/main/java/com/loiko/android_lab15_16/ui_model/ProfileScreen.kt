            ...
            Card(modifier = Modifier.fillMaxWidth()) {
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    Row(
                        ...
                        StatisticItem(label = "Средний балл", value = "4.7")
                        StatisticItem(label = "Бонусов", value = "180")
                        StatisticItem(label = "Дисциплин", value = "20")
                    }
                }
            }
        }
